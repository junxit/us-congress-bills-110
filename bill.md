...
- **(2)** by inserting after subsection (c) the following:
  > - **(d)**
  >   - **(1)** The Postal Service may not enter into any contract described in paragraph (2) without first satisfying the requirements of paragraph (3).
