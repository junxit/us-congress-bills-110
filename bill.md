...
This Act may be cited as the “Economic Development Revitalization Act of 2008”.
...
- **(1)** in subsection (b)—
  ...
  - **(B)** in paragraph (3), by inserting “, innovation, entrepreneurship, sustainable development,” after “infrastructure”;
- **(2)** in subsection (c), by inserting “(including economic development districts)” after “local government agencies”; and
- **(3)** by adding at the end the following:
...
- **(2)** in subsection (d)(5), by striking “subsection shall” and all that follows through the end of the paragraph and inserting the following: “subsection shall—
...
- **(a)** *Federal share* Section 204(a) of the Public Works and Economic Development Act of 1965 (42 U.S.C. 3144(a)) is amended by striking “shall not exceed—” and all that follows through the end of the subsection and inserting “shall not exceed 50 percent.”.
- **(b)** *Increase in Federal share* Section 204(c) of the Public Works and Economic Development Act of 1965 (42 U.S.C. 3144(c)) is amended—
  ...
  - **(2)** by inserting before paragraph (2) (as redesignated by paragraph (1)) the following:
    ...
    >   - **(D)** *Additional criteria* The Secretary may establish eligibility criteria in addition to the criteria described in this paragraph to address areas impacted by severe outmigration, sudden and severe economic dislocations, and other related economic circumstances.
...
## § 6. Grants for training, research, and technical assistance
...
## § 7. Enhancement of recipient flexibility to deal with project assets
...
## § 8. Brightfields demonstration program
...
## § 9. Designation of economic development districts
...
>     - **(C)** coordinating the development and implementation of the comprehensive economic development strategy with other local, State, Federal, and private organizations.
...
## § 10. Consultation with other persons and agencies
...
## § 11. Notification of reorganization
...
## § 13. Extension of authorization of appropriations
...
## § 14. Funding for grants for planning and grants for administrative expenses
