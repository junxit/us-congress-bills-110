...
- **(2)** by adding at the end the following:
  ...
  >     - **(III)** no period of appointment may exceed the date on which the Office of the Special Inspector General terminates under subsection (j).

## § 4. Response to audits and cooperation and coordination with other entities

Section 121 of the Emergency Economic Stabilization Act of 2008 (division A of Public Law 110–343) is amended—

- **(1)** by redesignating subsections (f), (g), and (h) as subsections (h), (i), and (j), respectively; and
