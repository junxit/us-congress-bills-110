...
- **(2)** by inserting after section 506C the following:
  ...
  >   - **(1)** possess or receive unfinished dex­tro­meth­orphan, unless the person is registered under section 510; or
  >   - **(2)** distribute unfinished dextromethorphan to any person other than a person registered under section 510.
  > - **(b)** *Exception for common carriers* This section does not apply to a common carrier that possesses, receives, or distributes unfinished dextromethorphan for purposes of distributing such unfinished dex­tro­meth­orphan between persons registered under section 510.
