...
- **(2)** while ethanol has been successful in the market place as a fuel additive, newer biobased fuels may present unique challenges that may render the fuels incompatible with the current fuel transportation and delivery infrastructure, placing the burden of costly refurbishment and construction on fuel distributors and retailers;
- **(3)** chemical additives to the fuels may mitigate the negative impacts of some biobased fuels on existing infrastructure and preclude costly retrofitting or installation of new biobased fuel compatible infrastructure and transportation systems;
...
## § 3. Alternative fuel and ULSD infrastructure and additives research and development
...
## § 4. Sulfur testing for diesel fuels
...
## § 5. Standard reference materials and data base development
