...
- **(b)** *Applications*
  ...
  - **(5)** *Number of grants* The Secretary shall determine the number of grants to be awarded under the program based on the technical merits of the applications received. The number of grants awarded under the program shall not be less than 3 or more than 7, and at least half of the grants awarded shall be for plug-in hybrid technology.
...
- **(c)** *Program requirements; Two phases* Each grant recipient shall be required to complete two phases:
  ...
  - **(2)** *Phase two*
    - **(A)** *In general* In phase two, the recipient shall demonstrate advanced manufacturing processes and technologies by producing or retrofitting 50 advanced heavy duty hybrid vehicles.
