...
- **(a)** *Short title* This Act may be cited as the “Government Accountability Office Act of 2008”.
- **(b)** *References* Except as otherwise expressly provided, whenever in this Act an amendment is expressed in terms of an amendment to a section or other provision, the reference shall be considered to be made to a section or other provision of title 31, United States Code.
...
## § 3. Pay adjustment relating to certain previous years
...
- **(a)** *In general* Subchapter I of chapter 7 is amended by adding at the end the following:
