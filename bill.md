...
- **(1)** in subparagraph (B)—
  - **(A)** in clause (v)—
    ...
    - **(ii)** inserting “at all ports of entry” after “installed”;
  ...
  - **(D)** by adding at the end the following:
    ...
    >   - **(II)** to ensure that the time required to issue a passport or passport card is not anticipated to exceed 8 weeks.
...
## § 4. Travel facilitation initiatives
...
## § 5. Sense of Congress regarding implementation of the Western Hemisphere Travel Initiative
...
## § 6. Passport processing staff authorities

- **(a)** *Reemployment of civil service annuitants* Section 61(a) of the State Department Basic Authorities Act of 1956 (22 U.S.C. 2733(a)) is amended—
  - **(1)** in paragraph (1), by striking “To facilitate” and all that follows through “, the Secretary” and inserting “The Secretary”; and
  - **(2)** in paragraph (2), by striking “2008” and inserting “2010”.
- **(b)** *Reemployment of foreign service annuitants* Section 824(g) of the Foreign Service Act of 1980 (22 U.S.C. 4064(g)) is amended—
  - **(1)** in paragraph (1)(B), by striking “to facilitate” and all that follows through “Afghanistan,”; and
  - **(2)** in paragraph (2), by striking “2008” and inserting “2010”.

## § 7. Report on border infrastructure
...
- **(a)** *In general* Not later than 180 days after the date of enactment of this Act, the Secretary of Transportation, in consultation with the Secretary of Homeland Security, shall submit to the appropriate congressional committees a report on the adequacy of the infrastructure of the United States to manage cross-border travel associated with the NEXUS, FAST, and SENTRI programs. Such report shall include consideration of—
  - **(1)** the ability of frequent travelers to access dedicated lanes for such travel;
  - **(2)** the total time required for border crossing, including time spent prior to ports of entry;
  - **(3)** the frequency, adequacy of facilities and any additional delays associated with secondary inspections; and
  - **(4)** the adequacy of readers to rapidly read identity documents of such individuals.
