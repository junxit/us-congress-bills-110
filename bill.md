...
- **(b)** *Definitions* In this Act:
  ...
  - **(4)** *New discriminatory tax* The term “new discriminatory tax” means any tax imposed by a State or local jurisdiction that—
    ...
    - **(B)** was not generally imposed and actually enforced on mobile services, mobile service providers, or mobile service property prior to the date of enactment of this Act.
