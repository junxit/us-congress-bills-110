...
This Act may be cited as the “Foreclosure Rescue Fraud Act of 2008”.
...
- **(b)** *Contract requirements*
  ...
  - **(2)** *Terms and conditions of contract* The requirements described in this paragraph, with respect to a contract, are as follows:
    ...
    - **(B)** The contract is written in the principal language used by the homeowner.
...
- **(a)** *Liability established* Any foreclosure consultant who fails to comply with any provision of section 3 or 4 with respect to any other person shall be liable to such person in an amount equal to the sum of the amounts determined under each of the following paragraphs:
  ...
  - **(2)** *Punitive damages* In the case of any action by an individual, such amount (in addition to damages described in paragraph (1)) as the court may allow.
