...
- **(c)** *Separate Application of Limitations on Foreign Tax Credit for Imported Property Income*
  ...
  - **(2)** *Imported property income defined* Paragraph (2) of section 904(d) of such Code is amended by redesignating subparagraphs (I) and (J) as subparagraphs (J) and (K), respectively, and by inserting after subparagraph (H) the following new subparagraph:
