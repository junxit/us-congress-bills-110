...
## § 2. Premium pay for multilingual proficiency

- **(a)** *In general* Section 5545 of title 5, United States Code, is amended by adding at the end the following:
  > - **(e)**
  >   - **(1)** An employee in a position requiring the use of one or more languages besides English is entitled to his rate of basic pay plus premium pay amounting to 5 percent of that rate.
