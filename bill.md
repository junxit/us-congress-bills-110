...
- **(a)** *Findings* Congress makes the following findings:
  ...
  - **(6)**
    ...
    - **(C)** The new method of selection described in the Governance Report reflects the single category of members of the Board of Governors that will result from the implementation of this Act:
