...
- **(a)** *In general* Section 804 of the Federal Food, Drug, and Cosmetic Act (as amended in section 4) is amended by adding at the end the following:
  ...
  >     - **(A)** *Presumption* A difference (including a difference in active ingredient, route of administration, dosage form, strength, formulation, manufacturing establishment, manufacturing process, or person that manufactures the drug) created after January 1, 2007, between a prescription drug for distribution in the United States and the drug for distribution in a permitted country shall be presumed under paragraph (1)(H) to be for the purpose of restricting importation of the drug into the United States under this section.
