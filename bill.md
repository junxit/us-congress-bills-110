...
- **(7)** *Promising* The term promising, when used with respect to a practice relating to juvenile delinquency and criminal street gang activity prevention and intervention, means a practice that is not evidence-based, but—
  - **(A)** that has outcomes from an evaluation that demonstrate that such practice reduces juvenile delinquency and criminal street gang activity; or
...
- **(23)** Direct expenditure for jails and prisons, correctional personnel, prosecution, and law enforcement strategies that lead to increased incarceration have been steadily increasing. In fiscal year 2005, Federal, State, and local governments spent an estimated $204,000,000,000 for police protection, corrections, and judicial expenses, a 5.5 percent increase over the previous year.
