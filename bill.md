...
## § 1. High-performance computing research and development program
...
- **(2)** in section 101(a)—
  - **(A)** by striking subparagraphs (A) and (B) of paragraph (1) and inserting the following:
  ...
  - **(C)** in paragraph (2), as so redesignated by subparagraph (B) of this paragraph—
    - **(i)** by striking subparagraph (B);
    - **(ii)** by redesignating subparagraphs (A) and (C) as subparagraphs (D) and (F), respectively;
    - **(iii)** by inserting before subparagraph (D), as so redesignated by clause (ii) of this subparagraph, the following new subparagraphs:
    ...
    - **(iv)** by inserting after subparagraph (D), as so redesignated by clause (ii) of this subparagraph, the following new subparagraph:
  ...
  - **(D)** in paragraph (3), as so redesignated by subparagraph (B) of this paragraph—
...
- **(3)** by striking subsection (b) of section 101 and inserting the following:
  ...
  >     - **(D)** whether the research and development undertaken pursuant to the Program is helping to maintain United States leadership in high-performance computing and networking technology; and
...
- **(5)** by striking the period at the end of paragraph (6) and inserting “; and”; and
- **(6)** by adding at the end the following new paragraph:
  > - **(7)** “Program Component Areas” means the major subject areas under which are grouped related individual projects and activities carried out under the Program.
